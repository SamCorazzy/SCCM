...
<body>
    <div>
        <div>
            <br>
            <h1 class="text-center" >SCCM</h1>
            <h6 class="px-5">Agrega los datos correspondientes</h6>
        </div>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text " id="basic-addon1">MEXICANOS POR</span> 
                            <div class="btn-group px-4" role="group" aria-label="Basic radio toggle button group">
                                ...
                                <label class="btn btn-outline-secondary " for="btnradio1">NACIONALIZADO</label> 
                                <!--Button 2-->
                                <input type="radio" class="btn-check mx-1" name="btnradio" id="btnradio2" autocomplete="off">
                                <label class="btn btn-outline-secondary" for="btnradio2">NATURALIZADO</label>
                            </div>
                    </div>
