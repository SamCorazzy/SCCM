...
{ //relleno del array segun los datos que se desean obtener de la consulta hasta que todos los datos se guarden en el
	...
	$datosR[] = array('sinestudios'=> $sinestudios,
...
$json_string = json_encode($datosR);//documento json que se usa para almacenar los datos del array
echo $json_string;
