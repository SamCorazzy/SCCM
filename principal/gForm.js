...
//agrega elementos al arreglo
    ...
    if (matricula == '' || nombre_apellidos == '' || fecha_nac == '' || lugar_nac == '' || curp == '' || mexicanos_por == '' || nombre_ape_padre == '' || nombre_ape_madre == '' || estado_civil == '' || ocupacion == '' || leer_escribir == '' || grado_maximo_estudio == '' || domicilio == '' || fecha_exped == '' || clase == '') {//sentencia if para verificar que ninun campo este vacio y si esta vacio algun campo mande una alerta
        Swal.fire({
            position: 'center',
            icon: 'error',
