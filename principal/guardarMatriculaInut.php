...
foreach ($datos as $datos) {//un metodo for each php para recorrer el arreglo y conseguir los datos
    ...
    //Ya que esta consulta busca obtener cuanto es el valor almacenado en el campo inutilizadas de la
    //tabla matricula
    ...
    foreach($obtener as $obtener){//se hace un ciclo foreach para poder leer los datos
        $num = $obtener['inutilizadas'];//se asigna l valor a la variable $num
    }
    $inutilizadas = $num + 1;//se le suma 1 a la variable $num
