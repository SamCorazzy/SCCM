<?php
//archivo que se usa para revisar si la curp esta siendo usada el cual se obtiene del documento 
...
//Creamos la conexión
$curp = $_POST['json'];//obtiene el valor de curp del archivo gForm.js 
$resultado;
